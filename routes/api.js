...
loghandler = {
    ...
    nottoken: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'masukan parameter Token, token hanya untuk admin'
    },
    notquery: {
        status: false,
        creator: `${creator}`,
    ...
    error: {
        status: 404,
        creator: `${creator}`,
        message: 'An internal error occurred. Please report via WhatsApp wa.me/6289626029135'
    }
}


let listkey = ["katashi", "Katashi", "Putra", "Pipiw"];
let token = ["utaaavii", "utaa", "avii"];

//testing Add api & delete
